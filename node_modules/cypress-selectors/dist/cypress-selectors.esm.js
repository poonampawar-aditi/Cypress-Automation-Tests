import { max, flow, toArray, fromPairs, pick } from 'lodash-es';
...
var getMaxTimeout = function getMaxTimeout(selectors) {
  ...
  return max(selectors.map(function (_ref) {
    var _config$timeout;
...
var generateLogEntryForXPathResult = function generateLogEntryForXPathResult(result, selector, type) {
  ...
  if (typeof result !== 'object') return {
    ...
    if ('length' in result && 'nodeType' in result === false) {
      var nodeTypes = toArray(result).map(function (r, id) {
...
var NOTE_TYPE_TO_LABEL_MAPPING = /*#__PURE__*/fromPairs([[1, 'ELEMENT_NODE'], [2, 'ATTRIBUTE_NODE'], [3, 'TEXT_NODE'], [4, 'CDATA_SECTION_NODE'], [5, 'ENTITY_REFERENCE_NODE'], [6, 'ENTITY_NODE'], [7, 'PROCESSING_INSTRUCTION_NODE'], [8, 'COMMENT_NODE'], [9, 'DOCUMENT_NODE'], [10, 'DOCUMENT_TYPE_NODE'], [11, 'DOCUMENT_FRAGMENT_NODE'], [12, 'NOTATION_NODE']]);
...
var BuildSelectorBy = function BuildSelectorBy(type, engine) {
  return function (value, externalConfig) {
    ...
    var safeConfig = pick(externalConfig, configAttributes);
...
export { By, ByAttribute, ByClass, ByExactLinkText, ByExactText, ById, ByName, ByPartialLinkText, ByPartialText, BySelector, ByType, ByXPath, ConfigureSelectors, ResetSelectorsConfiguration };
//# sourceMappingURL=cypress-selectors.esm.js.map
